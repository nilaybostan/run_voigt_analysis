...
void testmacro_Rocco_Zregion_with_criteria(const std::string &inputFileName, bool isMC = false) {
    RoccoR rc;
    ...
    // NanoAOD variables with correct types
    Int_t   nMuon;
    ...
    if (isMC) tree->SetBranchAddress("Muon_genPt", Muon_genPt);
